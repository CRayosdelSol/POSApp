...
namespace _POS
{
    public partial class btnG_ScannerSettings : UserControl
    {
        public btnG_ScannerSettings()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.Magenta; this.BackColor = Color.Magenta; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.DarkMagenta; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.Purple; this.BackColor = Color.Purple; this.Invalidate();
        }
