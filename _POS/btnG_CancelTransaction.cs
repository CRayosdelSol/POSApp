...
namespace _POS
{
    public partial class btnG_CancelTransaction : UserControl
    {
        public btnG_CancelTransaction()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.IndianRed; this.BackColor = Color.IndianRed; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.DarkRed; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.Firebrick; this.BackColor = Color.Firebrick; this.Invalidate();
        }
