...
namespace _POS
{
    public partial class btnG_StartScanning : UserControl
    {
        public btnG_StartScanning()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.CornflowerBlue; this.BackColor = Color.CornflowerBlue; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.MidnightBlue; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.RoyalBlue; this.BackColor = Color.RoyalBlue; this.Invalidate();
        }
