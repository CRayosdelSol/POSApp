...
namespace _POS
{
    public partial class btnG_DeleteItems : UserControl
    {
        public btnG_DeleteItems()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.LightSalmon; this.BackColor = Color.LightSalmon; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.DarkSalmon; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.Coral; this.BackColor = Color.Coral; this.Invalidate();
        }
