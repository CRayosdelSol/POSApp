...
namespace _POS
{
    public partial class btnG_TaxMultiplier : UserControl
    {
        public btnG_TaxMultiplier()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.MediumPurple; this.BackColor = Color.MediumPurple; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.Indigo; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.BlueViolet; this.BackColor = Color.BlueViolet; this.Invalidate();
        }
