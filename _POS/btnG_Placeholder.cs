...
namespace _POS
{
    public partial class btnG_Placeholder : UserControl
    {
        public btnG_Placeholder()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.SandyBrown; this.BackColor = Color.Pink; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.SaddleBrown; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.Chocolate; this.BackColor = Color.Chocolate; this.Invalidate();
        }
