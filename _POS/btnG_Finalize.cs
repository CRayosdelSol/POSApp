...
namespace _POS
{
    public partial class btnG_Finalize : UserControl
    {
        public btnG_Finalize()
        {
            InitializeComponent();
        }
        ...
        {
            p.Color = Color.DarkCyan; this.BackColor = Color.DarkCyan; this.Invalidate();
        }

        protected void onMouseDown()
        {
            this.BackColor = Color.CadetBlue; this.Invalidate();
        }

        protected void NormalStyle()
        {
            p.Color = Color.DarkSlateGray; this.BackColor = Color.DarkSlateGray; this.Invalidate();
        }
